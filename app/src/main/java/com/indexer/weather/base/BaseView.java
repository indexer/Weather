...
public interface BaseView {
  ...
  /**
   * This is a general method used for showing some kind of progress during a background task. For
   * example, this method should show a progress bar and/or disable buttons before some background
   * work starts.
   */
  void showProgress();
